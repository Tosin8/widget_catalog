...
// SHOWING REFRESHINDICATOR THAT CAN BE TRIGGERED IN DIFFERENT WAYS.
...
//REFRESHINDICATOR IN A NESTED SCROLL USING THE NOTIFICATIONPREDICATE PROPERTY.

class RefreshIndicatorExample1 extends StatefulWidget {
  const RefreshIndicatorExample1({super.key});

  @override
  State<RefreshIndicatorExample1> createState() =>
      _RefreshIndicatorExample1State();
}

class _RefreshIndicatorExample1State extends State<RefreshIndicatorExample1> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: RefreshIndicator(
          ...
          backgroundColor: Colors.blue,
          onRefresh: () async {
            // Replace this delay with the code to be executed during refresh and return asynchronous code
            return Future<void>.delayed(const Duration(seconds: 3));
